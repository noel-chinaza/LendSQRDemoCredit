...
import { MSG_NON_EXISTENT_DESTINATION_USER, MSG_SENDER_HAS_INSUFFICIENT_FUNDS } from "../messages/profile.message";
...
export class ProfileHandler {
	...
	async transferMoneyToOtherUser(data: {
		...
		await GenericCheckerInternal(TRANSFER_MONEY_TO_OTHER_USER_VALIDATOR_BODY, data);
